...
public class Stop_Over40_Days_Prompt extends Generic_Scenario {
  ...
  public void Testing() {
    try {
     ...
     // List<Debit_Order_Converted_Data> test_data_tc_01;
      ...
      //Enter Pin
      //D_order.pass_Data(test_data_tc_01.get(0).getPin_Number(), dialogID, "Announce.DebitOrderOneAtTime", "Ask.Pin");
      ...
      D_order.pass_Data("",dialogID,"Announce.MoreThanOneDebitOrder"," Announce.DeepLinkEducationalMessage");
      //Enter Pin
      //Enter Pin
        Authenticate();
      //Confirm if you wanna Stop
      ...
      D_order.pass_Data(test_data_tc_01.get(0).getMarchent(), dialogID,
          "Announce.ReactionBeforeTransfer", "Ask.Merchant");
