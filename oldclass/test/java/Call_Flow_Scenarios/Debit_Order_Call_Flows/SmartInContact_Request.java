...
public class SmartInContact_Request extends Generic_Scenario
{
  ...
  public void Testing () {
    try {
      ...
      Smart_Incontact smart=new Smart_Incontact(test,D_order);
      //Enter ID number
      D_order.pass_Data(test_data_tc_01.get(0).getID_Number(), dialogID, "Call.SendSmartInContact",
          "Ask.IdNumber");
      D_order.pass_Data("", dialogID, "Ask.CardNumber",
          "Call.SendSmartInContact");
