...
public class Repeat_Terms_and_Condictions extends Generic_Scenario {
  ...
  public void Testing() {
    try {
     ...
     // List<Debit_Order_Converted_Data> test_data_tc_01;
      ...
      test_data_tc_01 = test_data.stream()
          .filter(datad -> datad.getTest_CaSe_ID().equals("TC_25"))
    ...
    //  D_order.pass_Data(test_data_tc_01.get(0).getPin_Number(), dialogID, "Ask.ReverseStop","Ask.Pin");
      ...
      D_order.pass_Data(test_data_tc_01.get(0).getReverse_Stop(), dialogID,
          "Announce.DebitOrderOneAtTime", "Ask.ReverseStop");
     ...
     // D_order.pass_Data(test_data_tc_01.get(0).getMultiple(), dialogID, "Ask.SkipTerms", "Ask.Merchant");
      ...
      D_order.pass_Data(test_data_tc_01.get(0).getSkip_terms(), dialogID, "Ask.BargeInTerms",
          "Ask.SkipTerms");
      D_order.pass_Data("", dialogID, "Ask.RepeatTerms", "Ask.BargeInTerms");
      D_order.pass_Data("yes", dialogID, "Announce.Terms", "Ask.RepeatTerms");
      D_order.pass_Data("",dialogID,"Ask.RepeatTerms","Announce.Terms");
      D_order.pass_Data("no", dialogID, "Confirm.TermsAcceptance", "Announce.Terms");
      //Confirm terms and condictions
      D_order.pass_Data(test_data_tc_01.get(0).getConfirm_Terms(), dialogID, "Ask.DisputeReason",
          "Confirm.TermsAcceptance");

      //provide dispute reason
      D_order.pass_Data(test_data_tc_01.get(0).getDisputeReason(), dialogID, "Confirm.DisputeOrder",
          "Ask.DisputeReason");
      //confirm debit order
      D_order.pass_Data("no", dialogID, "Announce.ReactionBeforeTransfer", "Confirm.DisputeOrder");
