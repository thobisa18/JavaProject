...
public class Invalid_Card_Number extends Generic_Scenario {
  ...
  public void Testing() {
    try {
      ...
      //Enter Card number
      D_order.pass_Data("",dialogID,"Ask.CardNumber"," Announce.DeepLinkEducationalMessage");


      //Enter invalid Card number
      D_order.pass_Data(test_data_tc_01.get(0).getCard_Number(), dialogID, "Ask.CardNumber",
          "Ask.CardNumber");
      //Enter invalid Card number
      D_order.pass_Data(test_data_tc_01.get(0).getCard_Number(), dialogID, "Ask.CardNumber",
          "Ask.CardNumber");
      //Enter invalid Card number
      D_order.pass_Data(test_data_tc_01.get(0).getCard_Number(), dialogID,
          "Announce.ReactionBeforeTransfer", "Ask.CardNumber");
      //Check if the prompt is matching
