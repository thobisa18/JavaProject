...
public class Dispute_One_Debit_Order_End_To_End extends Generic_Scenario
{
  ...
  public void Testing ()
  {
    ...
    test_data_tc_01=test_data.stream()
        .filter(datad->datad.getTest_CaSe_ID().equals("TC_01"))
   ...
   // D_order.getIntent(" Debit order");
    D_order.pass_Data("i want a debit order transaction list",dialogID,"Confirm.DisputeTransaction","Ask.Intent");
