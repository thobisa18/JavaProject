...
public class No_To_DO_Confirmation extends Generic_Scenario
{
  ...
  public void Testing ()
  {
    String reason="unauthorized order, previously stopped, company didn";
    try {
      TC_ID="TC_01";
      ...
      test_data_tc_01=test_data.stream()
          .filter(datad->datad.getTest_CaSe_ID().equals("TC_24"))
      ...
      D_order.pass_Data(test_data_tc_01.get(0).getSkip_terms(),dialogID,"Ask.BargeInTerms","Ask.SkipTerms");
      D_order.pass_Data("",dialogID,"Ask.RepeatTerms","Ask.BargeInTerms");
      D_order.pass_Data("no",dialogID,"Confirm.TermsAcceptance","Ask.RepeatTerms");
