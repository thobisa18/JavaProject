...
public class Not_Accept_Term_and_Condictions extends Generic_Scenario
{
  ...
  public void Testing ()
  {
    try {
     ...
     // List<Debit_Order_Converted_Data> test_data_tc_01;
      ...
      //Enter ID number
      D_order.pass_Data(test_data_tc_01.get(0).getID_Number(),dialogID,"Announce.DeepLinkEducationalMessage","Ask.IdNumber");
      //Enter Card number
...
D_order.pass_Data("",dialogID,"Ask.ReverseStop","Ask.ReverseStop@Announce.DebitOrderOneAtTime@Ask.CardNumber" );
