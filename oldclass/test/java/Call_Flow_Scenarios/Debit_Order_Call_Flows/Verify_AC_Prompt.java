...
public class Verify_AC_Prompt extends Generic_Scenario {
  ...
  public void Testing() {
    try {
      ...
      test_data_tc_01 = test_data.stream()
          .filter(datad -> datad.getTest_CaSe_ID().equals("TC_32"))
      ...
      //Enter Card number
      D_order.pass_Data("",dialogID,"Announce.DebitOrderOneAtTime"," Announce.DeepLinkEducationalMessage");
      Authenticate();
