...
public class Not_Provide_Amount extends Generic_Scenario {
  ...
  public void Testing() {
    ...
    try {
     ...
     // List<Debit_Order_Converted_Data> test_data_tc_01;
      ...
      D_order.pass_Data("No",dialogID,"Announce.DeepLinkEducationalMessage@Ask.CardNumber","Ask.IdNumber");

      //Enter Pin
      D_order.pass_Data("",dialogID,"Ask.ReverseStop"," Announce.DeepLinkEducationalMessage");
      ...
      D_order.pass_Data("", dialogID, "Announce.DebitOrdersToMenu", "Ask.Merchant");
      D_order.pass_Data("", dialogID, "Ask.Merchant", "Ask.Merchant");
      D_order.pass_Data("", dialogID, "Ask.Merchant", "Ask.Merchant");
      D_order.pass_Data("", dialogID, "Ask.Merchant", "Ask.Merchant");
      // D_order.pass_Data("", dialogID, "Ask.Merchant", "Ask.Merchant");
      D_order
          .pass_Data("", dialogID, "Announce.ReactionBeforeTransfer", "Announce.DebitOrdersToMenu");
