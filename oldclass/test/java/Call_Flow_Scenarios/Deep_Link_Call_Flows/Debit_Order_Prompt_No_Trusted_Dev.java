 ...
 * <p>
 * This class/scenario  Ensure that 'Debit order service is not availabe' prompt is played
 * when customer is not having a trusted device
...
public class Debit_Order_Prompt_No_Trusted_Dev extends Generic_Scenario
{
  @BeforeClass
